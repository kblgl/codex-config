...
const HOOK_MANIFEST_TARGETS = [
  {
    ...
    manifest: () => ({
      ...
      hooks: {
        PostToolUse: [
          {
            ...
            hooks: [
              {
                type: 'command',
                command: 'node "${CLAUDE_PROJECT_DIR}/.codex/skills/impeccable/scripts/hook.mjs"',
        ...
        Stop: [stopManifestEntry('node "${CLAUDE_PROJECT_DIR}/.codex/skills/impeccable/scripts/hook.mjs"')],
      },
    }),
  },
  {
