...
- Cursor can block a proposed write when the detector finds a real issue. Codex, Codex, and GitHub Copilot do not block the edit; they emit a post-edit reminder instead. Disabling stops both blocking and reminders.
